...
<div id="header"></div>
        ...
        <div class="login-box">
        	...
        	<div class="login_inner">
        		...
        		<div id="errorMsg" class="alert alert-danger" >
					<%= (null == request.getAttribute("loginError"))? "": request.getAttribute("loginError")%>
				</div>
				<form id="loginForm" action="LoginHttpServlet" method="post" accept-charset="utf-8">
        			...
        			<div class="verify">
						...
						<span><img src="checkCode" alt="" onclick="getCheckCode(this)" ></span>
					</div>
	...
	<script>
		function getCheckCode(obj) {
			obj.src = "checkCode?a="+Math.random();
        }
	</script>
</body>
